    ...
    @endif
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="proReg" class="nav-link">Product_Reg</a></li>
	          <li class="nav-item"><a href="contact.html" class="nav-link">Contact</a></li>
	          <li class="nav-item cta cta-colored"><a href="cart" class="nav-link"><span class="icon-shopping_cart"></span>{{$count}}</a></li>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <p>Quality Veges At Your Door step</p>
          </div>
        </div>   		
    	</div>
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="userLogin" class="img-prod"><img class="img-fluid" src="products/{{$data['file']}}" alt="">
    						<span class="status">{{$data['discount_detail']}}</span>
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
							
    						<h3><a href="userLogin">{{$data['name']}}</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
									@if($data['discount'] == "")
		    						<p class="price"><span class="mr-2 price-dc"></span><span class="price-sale">N{{$data['price']}} Per Kg</span></p>
		    					    @else
									<p class="price"><span class="mr-2 price-dc">N{{$data['price']}}</span><span class="price-sale">N{{$data['discount']}} Per Kg</span></p>
									@endif
								</div>
	    					</div>
                            

	    					<div class="bottom-area d-flex px-3" style="margin-left: 30px">
	    						
								<form action="{{url('add2cart',$data['id'])}}" method="POST" id="form1">
									...
									<div class="m-auto d-flex" style="margin: 10px">
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>Quality Veges At Your Domot.</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Shop 89  New Haven Market</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+2 34 8160497532</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@afia9ine.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
